...
KOReader runs in portrait. The splash screen asks you to **turn the console 90° clockwise**: the power and volume buttons end up on the right, the USB-C port on the left. If you'd rather hold it the other way round, pick the inverted portrait orientation in KOReader's rotation settings.
